...
📋 Project Overview
This project analyzes supply chain and logistics data from DataCo, a global e-commerce company, to identify delivery performance issues, optimize shipping operations, and uncover insights for improving customer satisfaction. The analysis uses PostgreSQL to demonstrate advanced SQL skills including data normalization, complex JOINs, window functions, and business intelligence queries.
🎯 Business Objectives
